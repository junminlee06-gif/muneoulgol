...
mark.id = 'ch1Mark';
mark.textContent = 'ch1-expansion v2026-06-10d';
...
function adoptOriginalMidReport(){ if(P.done)return; P.active=true; P.day=2; P.stage='d2'; P.count=0; P.max=2; add(P.off,'1장 첫 보고: 중간 보고서 제출'); const d=document.getElementById('dialog'); if(d)d.style.display='none'; P.dialog=false; show('2일차 아침','첫 보고가 마을의 공기를 바꾸었다. 아직 사건은 끝나지 않았다. 둘째 날 조사를 이어간다.',[{text:'둘째 날 조사를 시작한다',run:close}]); }
