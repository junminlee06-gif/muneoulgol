...
mark.id = 'ch1Mark';
mark.textContent = 'ch1-expansion v2026-06-10e';
...
function report1(){ P.stage='report'; show('첫 보고서','아래 항목을 고르면 보고서가 제출되고 1일차 밤 조사로 이어진다.',[{text:'보고서 제출: 범의 흔적',e:{b:[['beast',2]],o:['1장 첫 보고: 범의 흔적']},response:'보고서가 접수되었다. 그러나 밤이 되자 범이라는 말만으로는 설명되지 않는 소리가 들린다.',run:startNight1},{text:'보고서 제출: 사람의 흔적',e:{b:[['human',2]],o:['1장 첫 보고: 사람의 흔적']},response:'보고서가 접수되었다. 사람을 의심하는 문장이 마을을 조용하게 만든다.',run:startNight1},{text:'보고서 제출: 산제 흔적',e:{b:[['ritual',2]],o:['1장 첫 보고: 산제 흔적']},response:'보고서가 접수되었다. 막례는 밤길을 조심하라고 말한다.',run:startNight1},{text:'보고서 제출: 마을 은폐',e:{b:[['conceal',2]],o:['1장 첫 보고: 마을 은폐']},response:'보고서가 접수되었다. 을파의 얼굴에서 웃음이 사라진다.',run:startNight1},{text:'보고서 제출: 판단 보류',e:{b:[['unknown',2]],o:['1장 첫 보고: 판단 보류']},response:'보고서가 접수되었다. 관아 전령은 더 분명한 문장을 요구한다.',run:startNight1}]); }
...
function night1(place){ if(!['well','shaman','mill'].includes(place))return toast('첫날 밤에는 우물, 무당집, 방앗간 중 한 곳만 확인하자.'); const D={well:['첫날 밤의 우물','우물 속에서 도리의 이름이 한 박자 늦게 돌아온다.',{b:[['ritual',1]],c:['우물의 이름 반응'],n:['도리 이름에 우물이 반응했다']}],shaman:['첫날 밤의 무당집','막례는 잠들지 않았다. 금줄을 맨 손끝이 떨린다.',{b:[['ritual',1]],c:['밤의 금줄'],n:['막례는 창귀 가능성을 에둘러 말했다']}],mill:['첫날 밤의 방앗간','멈춰 있던 물레가 천천히 돈다. 물소리 사이로 아이 목소리가 섞인다.',{b:[['human',1],['ritual',1]],c:['밤 방앗간의 물소리'],n:['방앗간에서 아이 목소리 같은 소리를 들었다']}]}[place]; show(D[0],D[1],[{text:'밤의 흔적을 기록한다',e:D[2],response:'첫날 밤 조사를 마쳤다. 새벽이 가까워지며 마을은 다시 낮의 얼굴을 되찾는다.',run:()=>beginDay2('night')}]); }
